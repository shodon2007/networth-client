	...
	return (
		<div className={cls.container}>
			<ul className={cls.visibilityList}>
				...
				<li className={cls.visibilityList__time}>
					<h6>Time:</h6>
					<input type="date" className={cls.visibilityList__time2} />
				</li>
			</ul>
			<ul className={cls.interactivityList}>
				<ul className={cls.interactivityList__items}>
					{PostModifiesIconsList.map((item, index) => {
						// Go through each element and display them
						return (
							<li key={index} className={cls.interactivityList__item}>
								<button>
